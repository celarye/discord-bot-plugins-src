...
> The current goal is for it to reach `v0.1.0` sometime in early to mid August.

> [!WARNING]
> The current commit history will **frequently be rewritten** until `v0.1.0` of
> the discord bot is released.

The source code of the plugins from the official [discord bot](https://github.com/celarye/discord-bot) registry.
